...
const Island = ({ isRotating, setIsRotating, setCurrentStage, ...props }) => {
  ...
  const dampingFactor = 0.95; //adjust speed of rotation

  const handlePointerDown = (e) => {
    e.stopPropagation();
    e.preventDefault();
    setIsRotating(true); //Lets the code know you are about to rotate when clicking down
    ...
    if (!isRotating) {
      ...
      switch (true) {
        case normalizedRotation >= 5.35 && normalizedRotation <= 5.95:
          setCurrentStage(4);
          break;
        case normalizedRotation >= 0.75 && normalizedRotation <= 1.55:
          setCurrentStage(3);
          break;
